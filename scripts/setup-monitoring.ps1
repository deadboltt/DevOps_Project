...
Write-Host ""
Write-Host "[1/4] Adding and updating Prometheus Community Helm repo..." -ForegroundColor Yellow
helm repo add prometheus-community https://prometheus-community.github.io/helm-charts
helm repo update

# 2. Deploy kube-prometheus-stack
Write-Host ""
Write-Host "[2/4] Deploying kube-prometheus-stack in 'monitoring' namespace..." -ForegroundColor Yellow
...
if ($LASTEXITCODE -ne 0) {
    Write-Host ""
    Write-Host "[!] Prometheus stack Helm installation failed. Ensure your Kubernetes cluster is reachable." -ForegroundColor Red
    exit 1
}

# 3. Apply Alert Rules, Alertmanager Config, and Dashboard ConfigMap
Write-Host ""
Write-Host "[3/4] Applying Custom Alert Rules and SRE Golden Signals Dashboard..." -ForegroundColor Yellow
...
Write-Host " [SUCCESS] Observability Stack Successfully Deployed!" -ForegroundColor Green
Write-Host "======================================================" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "To access Prometheus Query UI:" -ForegroundColor Cyan
